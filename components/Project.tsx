    ...
    <div className={`mx-8 sm:mx-16 md:mx-24 ${outerStyling}`}>
      <div className='grid grid-cols-12 max-w-screen-lg lg:mx-auto'>
        ...
        <div className='col-[2/12] md:col-[5/-1] row-[1/2] h-fit self-center text-left md:text-right'>
          <h2 className='relative z-10 text-2xl font-extrabold my-4'>
            {title}
          </h2>
          <p className='relative z-10 py-6 px-8 md:pl-16 my-4 bg-secondary-bg rounded-md shadow-md '>
            {description}
          </p>
          <ul className='relative z-10 w-fit flex flex-wrap gap-6 md:justify-end font-light my-4 ml-auto'>
            {tools.map((tool) => (
              <li key={tool}>{tool}</li>
            ))}
          </ul>
    ...
    <div className={`mx-8 sm:mx-16 md:mx-24 ${outerStyling}`}>
      <div className='grid grid-cols-12 max-w-screen-lg lg:mx-auto'>
        ...
        <div className='col-[2/12] md:col-[1/9] row-[1/2] h-fit self-center text-left'>
          ...
          <p className='relative z-10 py-6 px-8 md:pr-16 my-4 bg-secondary-bg rounded-md shadow-md '>
            {description}
          </p>
